...
namespace FirstNetCoreMVC.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(MovieContext context)
        {
            _context = context;
        }
        ...
        {
            var movieContext = _context.Departments.Include(d => d.Administrator);
        ...
        {
            ViewData["InstructorsList"] = new SelectList(_context.Instructors, "Id", "FullName");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["InstructorsList"] = new SelectList(_context.Instructors, "Id", "FullName", department.InstructorId);
            return View(department);
        }
        ...
        public async Task<IActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            if (departmentToUpdate == null)
            {
                ...
                ViewData["InstructorsList"] = new SelectList(_context.Instructors, "Id", "FullName", deletedDepartment.InstructorId);
            ...
            ViewData["InstructorsList"] = new SelectList(_context.Instructors, "Id", "FullName", departmentToUpdate.InstructorId);
